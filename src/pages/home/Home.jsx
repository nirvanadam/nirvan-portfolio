  ...
  return (
    <div>
      ...
      <div className={`${showMenu ? "before:opacity-60" : "before:opacity-0"} relative before:contents-[''] before:z-10 before:absolute before:bg-black  before:top-0 before:left-0 before:right-0 before:bottom-0 before:transition-all`}>
        {/* Section 1 */}
        <section className="grid grid-cols-1 md:grid-cols-[2fr,1fr] lg:grid-cols-[2fr,1.5fr] md:items-center gap-5 md:gap-12 bg-primary text-white px-5 md:px-11 lg:px-16 py-5 md:py-16">
          <div className="flex flex-col gap-4 xl:gap-6">
            <h1 className="text-center md:text-left text-4xl md:text-[54px] lg:text-7xl xl:text-8xl md:leading-none">Front-end Web Developer</h1>
            <p className="xl:w-[60%] text-center md:text-xl xl:text-2xl md:text-left opacity-60 ">An enthusiastic front-end web developer with a passion for visual design and the ability to translate it into code.</p>
          </div>
        ...
        <section className="px-5 md:px-14 lg:px-16 py-10">
          ...
          <div className="flex flex-col gap-5">
            {/* Project 1 */}
            <button className="relative overflow-hidden h-[200px] md:w-full md:h-[400px] lg:h-[490px] xl:h-[680px] rounded-lg bg-yellow-400">
              ...
              <dix className="absolute left-3 md:left-10 bottom-6 md:bottom-11 flex lg:flex-col justify-center items-center gap-3 lg:items-start w-24 md:w-28 lg:w-[500px] lg:px-8 py-4 md:py-6 lg:py-8 rounded-lg bg-black">
                ...
                <Link className="flex jusitfy-center items-center gap-3">
        ...
        <section className="flex flex-col items-center gap-5 px-5 md:px-14 lg:px-28 py-20 md:py-28 lg:py-56 bg-primary">
          <h1 className="text-white text-center text-opacity-60 text-xs font-medium">LET'S TALK</h1>
          <h1 className="text-5xl md:text-7xl lg:text-8xl xl:text-9xl text-center text-white leading-tight">Let's make your Website shine.</h1>
